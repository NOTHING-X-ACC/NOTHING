...
exports.tanggal = (numer) => {
    const myMonths = ["January", "February", "March", "April", "May", "June", "Juli", "August", "September", "October", "November", "December"];
    const myDays = ['Sunday', 'Monday', 'Tuesday', 'Wednessday', 'Thursday', "Friday", 'Saturday'];
